...
# def get_badges():
#     badge_list = requests.get('http://www.khanacademy.org/api/v1/badges').json()
...
# def get_exercises():
#     exer_list = requests.get('http://www.khanacademy.org/api/v1/exercises').json()
...
#         }
#         #some dictionaries are missing keys
